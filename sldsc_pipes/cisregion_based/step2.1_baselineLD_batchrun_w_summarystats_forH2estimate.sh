...
#for sumstatsfile in ${sumstats_path}/*bloodtrait*; do
...
#run step3 script
bash /work-zfs/abattle4/surya/datasets/prs_project/scripts/sldsc_pipes/cisregion_based/run_step3.sh $prefix $annotpath

echo "partition final again: $PARTITION"
echo "time final again: $TIME"
echo -e "\tcore used final again: $CORE"
echo -e "\ttesting export final again: $TESTING"
