...
for each in /work-zfs/abattle4/surya/datasets/prs_project/ldsc/ldscDB/baselineLD_annot/*;do
    ...
    cp ${each} ${annotpath}/${prefix}/${filename}; 
...
bash /work-zfs/abattle4/surya/datasets/prs_project/scripts/sldsc_pipes/cisregion_based/run_step2.1.sh $prefix $annotpath
