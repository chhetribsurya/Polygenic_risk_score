...
ea_filepath = "/Users/suryachhetri/datasets/prs_project/geuvadis_eQTLs"
...
output_path = "/Users/suryachhetri/datasets/prs_project/final_hg19/coloc_geuvadis_montgo_eQTL"
...
def pop_shared_variants_colocformat(aa_filepath, ea_filepath, chromrange, pval, tissue, chrom_X=False):
    ...
    for chrom in chrom_list:
        ...
        """ parse eur cohorts"""
        col_names = ["molecular_trait_id", "chromosome", "position", "ref", "alt", "variant",
        ...
        select_cols = ['molecular_trait_id', 'variant', 'maf', 'pvalue', 'beta', 'se']     
        read_ea = read_ea.loc[:, select_cols]
        read_ea.rename(columns={"molecular_trait_id" : "phenotype_id", "variant" : "variant_id", "pvalue": "pval_nominal",
                                "beta": "slope", "se" :"slope_se"}, inplace=True)    
        ...
        read_aa["phenotype_id"] = read_aa["phenotype_id"].str.replace("\\..*", "") #remove transcript iso
        read_ea["phenotype_id"] = read_ea["phenotype_id"].str.replace("\\..*", "") #remove transcript iso
